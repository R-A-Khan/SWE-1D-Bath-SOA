...
str3 = sprintf('Results/SOAB1D5/Plots/case_%d_sigma_%d_dG_dm_integrated.eps', case_num, test(k));
print(str3, '-depsc2')
str5 = sprintf('Results/SOAB1D5/Plots/case_%d_sigma_%d_dG_dm_integrated.fig', case_num, test(k));
savefig(str5)
...
str3 = sprintf('Results/SOAB1D5/Plots/case_%d_N_obs_%d_bath_shape.eps', case_num, test(k));
print(str3, '-depsc2')
str5 = sprintf('Results/SOAB1D5/Plots/case_%d_N_obs_%d_bath_shape.fig', case_num, test(k));
savefig(str5)
    end
end
