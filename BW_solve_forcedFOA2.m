function [a, b, T, Y] = BW_solve_forcedFOA2(h, dt, u0, tmin, tmax, trend, beta, u_all, eta_all, dG_deta, dG_du)
% Usage: 
% Same as BW_SOLVE_FORCEDFOA but forcing terms are 2D instead of 1D
...
tRange = [tmin tmax];
[T,Y] = RK34_forced_FOA_bath2(dt, u0, tRange, trend, h, beta, u_all, eta_all, dG_deta, dG_du);
