...
x0_min      = -2.86;     % Location of first observation point
dmu         = 0.13;     % Spacing between observation points
...
str =sprintf('Results/SOAB1D10/DA Results/SOAB1D10_case_%d_x0_%d.mat', case_num, l);
