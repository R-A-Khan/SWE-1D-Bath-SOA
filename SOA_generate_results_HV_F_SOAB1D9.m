...
for l = 1:3
        %% Set DA Data Path
        data_file = sprintf('Results/SOAB1D9/DA Results/SOAB1D9_case_%d_x0_%d.mat', case_number,l);
        ...
        str =sprintf('Results/SOAB1D9/SOA Results/SOAB1D9_results_case_%d_x0_%d_GMRES.mat', case_number,l);
