...
for l = 1:4
        ...
        %% Set DA Data Path
        data_file = sprintf('Results/SOAB1D11/DA Results/SOAB1D11_case_%d_N_obs_%d.mat', case_number,N_obs_all(l));
        ...
        str =sprintf('Results/SOAB1D11/SOA Results/SOAB1D11_results_case_%d_N_obs_%d_GMRES.mat', case_number,N_obs_all(l));
