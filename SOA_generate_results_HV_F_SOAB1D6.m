...
for case_number = 1
    ...
    for iter = 1:length(sigma)
        %% Set DA Data Path
        data_file = sprintf('Results/SOAB1D6/DA Results/SOAB1D6_case_%d_sigma_%d.mat', case_number, iter);
        ...
        str =sprintf('Results/SOAB1D6/SOA Results/SOAB1D6_results_case_%d_sigma_%d.mat', case_number, iter);
