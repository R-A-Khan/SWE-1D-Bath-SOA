...
x0_min      = start(l);     % Location of first observation point
dmu         = 0.06;     % Spacing between observation points
...
str =sprintf('SOAB1D9_case_%d_x0_%d.mat', case_num, l);
...
disp(sprintf('Case %d iteration %d with x0_min = %1.3f completed', case_number, l, x0_min));
    end
end