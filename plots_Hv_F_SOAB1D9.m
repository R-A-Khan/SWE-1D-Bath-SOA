...
% str4 = sprintf('Results/SOAB1D9/Plots/Case_3_Hv_F_case_%d.eps',test(k));
% print(str4, '-depsc2')

str5 = sprintf('Results/SOAB1D9/Plots/Case_1_Hv_F_case_%d.fig',test(k));
savefig(str5)
end
...
% str3 = sprintf('Results/SOAB1D9/Plots/Case_%d_dG_dm_case_%d.eps',case_num, test(k));
% print(str3, '-depsc2')
% 
% str5 = sprintf('Results/SOAB1D9/Plots/Case_%d_dG_dm_case_%d.fig',case_num, test(k));
% savefig(str5)
end
...
str3 = sprintf('Results/SOAB1D9/Plots/case_%d_x0_%d_dG_dm_integrated.eps', case_num, k);
print(str3, '-depsc2')
str5 = sprintf('Results/SOAB1D9/Plots/case_%d_x0_%d_dG_dm_integrated.fig', case_num, k);
savefig(str5)
...
str3 = sprintf('Results/SOAB1D9/Plots/case_%d_x0_%d_coverage.eps', case_num, k);
print(str3, '-depsc2')
str5 = sprintf('Results/SOAB1D9/Plots/case_%d_x0_%d_coverage.fig', case_num, k);
savefig(str5)
end
end
